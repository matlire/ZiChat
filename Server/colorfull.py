...
class Colourfull:
    ...
    # Printing colorfull patterns (server only)
    def print_server(self) -> None:
        self.print_magenta()
        print("[SERVER] ", end="")
    def print_server_from_to(self, _from : str, to : str) -> None:
        self.print_magenta()
        print(f"[SERVER from {_from} to {to}] ", end="")
